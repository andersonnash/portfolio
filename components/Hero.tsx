  ...
  return (
    <div className='pb-20 pt-36'>
      ...
      <div className='flex justify-center relative my-20 z-10'>
        <div className='max-w-[89vw] md:max-w-2x1 lg:mx-w-[60vw] flex flex-col items-center justify-center'>
          <h2 className='uppercase tracking-widest text-xs text-center text-blue-100 max-w-80'>
            Dynamic Wed Magic with Next.js
          </h2>
          <TextGenerateEffect 
            className='text-center text-[40px] md:text-5xl lg:text-6xl'  
          words="Transforming Concepts into Seamless User Experiences"/>
          <p className='text-center md:tracking-wider mb-4 text-sm md:text-lg lg:text-2x1'>
            Hi, I&apos;m Nash, a Next.JS and Ruby on Rails Developer living in Salt Lake City, Utah.
          </p>
          <a href='#about'>
            <MagicButton 
            position="right"
